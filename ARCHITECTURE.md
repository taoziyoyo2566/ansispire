...
- **Plugin Plane** (`plugins/`): Lightweight local extensions. `vps_runner` is the ansible-runner-native VPS lifecycle plugin — standard `inventory/vps_runner/<env>/` + CLI `list|audit|onboard|modify|remove`.
...
- [VPS Runner Plugin](docs/reference/feature-map/vps-runner.md)
