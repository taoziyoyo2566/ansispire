...
- **OS-family gating**: `infra_baseline` supports Debian/Ubuntu (Tier 1) and RHEL family (Tier 2, via `redhat.yml`) — the complete supported set (scope decision 2026-06-05). Any other family (e.g. Alpine) hits the unsupported-family `fail:` guard.
